...
Confirmation route appears without a new ADR. ADR-017 retires the former
ADR-010/011 single-image exceptions; import, replacement, and restore use
Adapter/Core/Toolkit. These operations remain Core proposal paths unless a
