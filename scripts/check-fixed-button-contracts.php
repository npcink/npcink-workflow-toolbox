...
$expected_ids = array( 'format_content', 'site_check', 'source_adaptation_review', 'publish_preflight', 'category_suggestions', 'tag_suggestions', 'internal_link_candidates', 'article_image_alt', 'image_candidates', 'article_narration', 'article_audio_summary', 'batch_image_optimization', 'batch_alt_review' );
$actual_ids   = array();
...
sort( $actual_ids );
sort( $expected_ids );
npcink_fixed_button_check( $expected_ids === $actual_ids, 'The table covers exactly the thirteen fixed-button contracts' );
